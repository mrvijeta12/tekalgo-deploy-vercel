    ...
    <div className="joinourteam">
      <div className="joinourteam_data_container">
        ...
        <div className="join_cards_container">
          <div className="join_cards join_card1" data-aos="fade-right">
            <h3>Open culture</h3>
            <p>
          ...
          <div className="join_cards  join_card2" data-aos="fade-left">
            <h3>Open culture</h3>
            <p>
              TekAlgo values an open environment where collaboration is
              encouraged, and every team member is seen as a contributor to our
          ...
          <div className="join_cards join_card3" data-aos="fade-right">
            <h3>Open culture</h3>
            <p>
              TekAlgo values an open environment where collaboration is
              encouraged, and every team member is seen as a contributor to our
          ...
          <div className="join_cards join_card4" data-aos="fade-left">
            <h3>Open culture</h3>
            <p>
              TekAlgo values an open environment where collaboration is
              encouraged, and every team member is seen as a contributor to our
        ...
        <div className="join_complex_problem_data" data-aos="zoom-in">
          <h2>
            <span>
        ...
        <div className="missin_vision_conatainer">
          ...
          <div className="missin_vision_data">
            <div className="mdata mdata_1" data-aos="fade-right">
              <h2>
                <span>
            ...
            <div className="mdata mdata_2" data-aos="fade-left">
              <p>
        ...
        <div className="join_user_comments_container" data-aos="zoom-in">
